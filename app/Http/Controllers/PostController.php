...
class PostController extends Controller
{
    ...
    public function submittal(Request $request){
        ...
        'eligibility6', 'rating5', 'dateofexam5', 'placeofexam5', 'licenseno5', 'validity5', 'datefrom5', 'dateto5', 'position5', 'department5', 'salary5', 'paygrade5', 'appointment5',
        'eligibility7', 'rating5', 'dateofexam5', 'placeofexam5', 'licenseno5', 'validity5', 'datefrom5', 'dateto5', 'position5', 'department5', 'salary5', 'paygrade5', 'appointment5',
