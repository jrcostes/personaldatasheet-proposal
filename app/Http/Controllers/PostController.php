...
class PostController
{
    ...
    public function submittal(Request $request){
        ...
        $data = $request->validate([
            ...
            'philhealthno' => 'max:15|nullable',
            'sssno' => 'max:15|nullable',
            'tinno' => 'max:15|nullable',
            'agencyemp' =>'max:63|nullable',
            'citizens' => 'required',
            ...
            'residentialsudv' => 'max:128',
            'residentialbrgy' => 'required|max:128',
        ...
        $c1answers = [
            ...
            'spouseempadd' => $data['spouseempadd'] ?? null,
        ...
        $c2answers = [
            ...
            'datefrom28' => $data['datefrom28'] ?? null,
            'dateto28' => $data['dateto28'] ?? null,
            'position28' => $data['position28'] ?? null,
            'department28' => $data['department28'] ?? null,
            'salary28' => $request->input('salary28') ?? null,
            'paygrade28' => $data['paygrade28'] ?? null,
            'appointment28' => $data['appointment28'] ?? null,
            'governmentserv28' =>  $data['governmentserv28'] ?? null
        ];
        $c3answers = [
