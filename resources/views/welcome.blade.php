        ...
        <ul class="sidebar-nav" data-coreui="navigation" data-simplebar>
            ...
            {{-- <li class="nav-group"><a class="nav-link nav-group-toggle" href="#">
                ...
                <ul class="nav-group-items">
                    <li class="nav-item"><a class="nav-link" href="/c1form"><span class="nav-icon"></span> C1
                            Form</a></li>
                    <li class="nav-item"><a class="nav-link" href=/c2form><span class="nav-icon"></span> C2 Form</a>
                    </li>
                    <li class="nav-item"><a class="nav-link" href=/c3form><span class="nav-icon"></span> C3 Form</a>
                    </li>
                    <li class="nav-item"><a class="nav-link" href="/c4form"><span class="nav-icon"></span> C4
                            Form</a></li>
            ...
            <div class="container-fluid">
                ...
                <ul class="header-nav ms-3">
                    <li class="nav-item dropdown"><a class="nav-link py-0" data-coreui-toggle="dropdown"
                            ...
                            <div class="avatar avatar-md"><img class="avatar-img" src="assets/img/avatars/7.jpg"
