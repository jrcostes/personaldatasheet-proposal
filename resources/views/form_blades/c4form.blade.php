                    ...
                    <h1>Please Check Applicable:</h1>
                        ...
                        <div class="references">
                            ...
                            <div class="41-b-container d-none">
                                <hr>
                                <b>{{Form::label('41name', "Name: ")}}</b>
                                {{Form::text('41name',null, array('class'=>'form-control', 'id' => '41-b-answer-name','placeholder' => 'Full Name', 'autocomplete' => 'off'))}}
                                <b>{{Form::label('41address', "Address: ")}}</b>
                                {{Form::text('41address',null, array('class'=>'form-control', 'id' => '41-b-answer-address','placeholder' => 'Address', 'autocomplete' => 'off'))}}
                                <b>{{Form::label('41contactno', "Telephone Number: ")}}</b>
                                {{Form::number('41contactno',null, array('class'=>'form-control', 'id' => '41-b-answer-contact-no','placeholder' => 'Tel No'))}}<br>
                            </div>
                            <div class="41-c-container d-none">
                                <hr>
                                <b>{{Form::label('41name', "Name: ")}}</b>
                                {{Form::text('41name',null, array('class'=>'form-control', 'id' => '41-c-answer-name','placeholder' => 'Full Name', 'autocomplete' => 'off'))}}
                                <b>{{Form::label('41address', "Address: ")}}</b>
                                {{Form::text('41address',null, array('class'=>'form-control', 'id' => '41-c-answer-address','placeholder' => 'Address', 'autocomplete' => 'off'))}}
                                <b>{{Form::label('41contactno', "Telephone Number: ")}}</b>
                                {{Form::number('41contactno',null, array('class'=>'form-control', 'id' => '41-c-answer-contact-no','placeholder' => 'Tel No'))}}<br>
                            </div>
                        ...
                        <b>{{Form::label('42govid', "Government Issued ID: ")}}</b>
                        {{ Form::select('country', $validID, null, ['class' => 'form-control', 'placeholder' => 'Select Country...']) }}
                        <b>{{Form::label('42valid', "ID/License/Passport No.: ")}}</b>
                        {{Form::number('42valid',null, array('class'=>'form-control', 'id' => '42-answer-valid-id-no','placeholder' => 'ID No.', 'autocomplete' => 'off' ,'maxlength' => 12))}}
                        {{Form::label('42issuanceplace','Place of Issuance: ')}}
                        {{Form::text('42issuanceplace',null, array('class'=>'form-control', 'id' => '42-answer-issuance-details','placeholder' => 'Place of Issuance', 'autocomplete' => 'off'))}}<br>
                        {{Form::label('42issuancedate','Date of Issuance: ')}}
                        {{Form::date('42issuancedate')}}
