...
@section('content')
    ...
    <head>
        ...
        <title>Personal Data Sheet C1</title>
    ...
    <body class="content">
        <div class="container">
            <form method="get" action="/c1formsubmit" autocomplete="off" class="form-horizontal">
                ...
                <div>
                    <br><br>
                    <p><em><b>WARNING: Any misrepresentation made in the Personal Data Sheet and the Work Experience Sheet
                                shall cause the filing of administrative/criminal case/s against the person
                                concerned.</b></em></p>
                    <p><em><b>READ THE ATTACHED GUIDE TO FILLING OUT THE PERSONAL DATA SHEET (PDS) BEFORE ACCOMPLISHING PDS
                                FORM.</b></em></p>
                    </p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-6 col-md-4">
                            ...
                            <label for="birthdate">Date of Birth</label><br>
                                ...
                                <input type="date" class="date-picker" name="birthdate" id="birthdate" data-coreui-toggle="date-picker" required>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm">
                            ...
                            <div class="col-auto my-1">
                                ...
                                <select class="form-select" aria-label="Default select example" id="bloodType" name="bloodType">
                                    <option selected>Select one...</option>
                ...
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="citizens" id="flexRadioDefault1" value="Filipino">
                    <label class="form-check-label" for="flexRadioDefault1">
                        Filipino
                    </label>
                    <br>

                    <input class="form-check-input" type="radio" name="citizens" id="flexRadioDefault2" value="Dual Citizenship">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <select class="form-select" aria-label="Default select example" id="citizens2" name="citizens2">
                ...
                <div class="row">
                    <div class="col">
                        {{ Form::text('telno', null, ['class' => 'form-control', 'id' => 'tel', 'placeholder' => 'Mobile No.']) }}
                    </div>
                    <div class="col">
                        {{ Form::text('mobno', null, ['class' => 'form-control', 'id' => 'mob', 'placeholder' => 'Telephone No.']) }}
                    </div>
                    <div class="col">
                    ...
                    <div class="children">
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input type="date" class="date-picker" name="birthchild0" id="birthchild0" data-coreui-toggle="date-picker">
                            </div>
                        </div>
                        ...
                        <div class="child1-container d-none">
                            <div class="row">
                                ...
                                <div class="col">
                                    ...
                                    <input type="date" class="date-picker" name="birthchild1" id="birthchild1" data-coreui-toggle="date-picker">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="child2-container d-none">
                            <div class="row">
                                ...
                                <div class="col">
                                    ...
                                    <input type="date" class="date-picker" name="birthchild2" id="birthchild2" data-coreui-toggle="date-picker">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="child3-container d-none">
                            <div class="row">
                                ...
                                <div class="col">
                                    ...
                                    <input type="date" class="date-picker" name="birthchild3" id="birthchild3" data-coreui-toggle="date-picker">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="child4-container d-none">
                            <div class="row">
                                ...
                                <div class="col">
                                    ...
                                    <input type="date" class="date-picker" name="birthchild4" id="birthchild4" data-coreui-toggle="date-picker">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="child5-container d-none">
                            <div class="row">
                                ...
                                <div class="col">
                                    ...
                                    <input type="date" class="date-picker" name="birthchild5" id="birthchild5" data-coreui-toggle="date-picker">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="child6-container d-none">
                            <div class="row">
                                ...
                                <div class="col">
                                    ...
                                    <input type="date" class="date-picker" name="birthchild6" id="birthchild6" data-coreui-toggle="date-picker">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="child7-container d-none">
                            <div class="row">
                                ...
                                <div class="col">
                                    ...
                                    <input type="date" class="date-picker" name="birthchild7" id="birthchild7" data-coreui-toggle="date-picker">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="child8-container d-none">
                            <div class="row">
                                ...
                                <div class="col">
                                    ...
                                    <input type="date" class="date-picker" name="birthchild8" id="birthchild8" data-coreui-toggle="date-picker">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="child9-container d-none">
                            <div class="row">
                                ...
                                <div class="col">
                                    ...
                                    <input type="date" class="date-picker" name="birthchild9" id="birthchild9" data-coreui-toggle="date-picker">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="child10-container d-none">
                            <div class="row">
                                ...
                                <div class="col">
                                    ...
                                    <input type="date" class="date-picker" name="birthchild10" id="birthchild10" data-coreui-toggle="date-picker">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="child11-container d-none">
                            <div class="row">
                                ...
                                <div class="col">
                                    ...
                                    <input type="date" class="date-picker" name="birthchild11" id="birthchild11" data-coreui-toggle="date-picker">
                                </div>
                            </div>
                        </div>
                    </div>
