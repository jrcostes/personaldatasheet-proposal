...
<head>
    ...
    <title>C2 Personal Data Sheet</title>
    <!-- bootstrap 5 css -->
        ...
        @csrf
            ...
            <div class="col-1 row px-0">
                <div class="col-5 offset-1 px-0">
                    <button type="button" class="btn btn-secondary btn-sm w-100" id="minus-top" onclick = "removetop()" disabled>-</button>
                </div>
                <div class="col-5 offset-1 px-0">
                    <button type="button" class="btn btn-secondary btn-sm w-100" id="add-top" onclick = "addtop()" >+</button>
                </div>
            </div><br>
            ...
            </br><h1>V. WORK EXPERIENCE</h1><br>

            <div class="col-1 row px-0">
                <div class="col-5 offset-1 px-0">
                    <button type="button" class="btn btn-secondary btn-sm w-100" id="minus-bottom" onclick = "removebottom()" disabled>-</button>
                </div>
                <div class="col-5 offset-1 px-0">
                    <button type="button" class="btn btn-secondary btn-sm w-100" id="add-bottom" onclick = "addbottom()" >+</button>
                </div>
            </div><br>
            ...
            <div class="button">
                <button type="submit" name="action" value="submit" class="btn btn-primary" onclick = "submitAlert()">Upload</button>
            </div>
        </form>
    </section>
    <!-- bootstrap js -->
...
<script>
    ...
    var formtop = document.getElementsByClassName("form-top");
    var plustop = document.getElementById('add-top');
    var minustop = document.getElementById('minus-top');

    var formbottom = document.getElementsByClassName("form-bottom");
    var plusbottom = document.getElementById('add-bottom');
    var minusbottom = document.getElementById('minus-bottom');

    function addtop() {
        if (top_counter < 6) {
            minustop.disabled = false;
            formtop[top_counter].style.display = "block";
            top_counter++;
            if (top_counter == 6) {
                plustop.disabled = true;
            }
        }
    }
    ...
    function removetop() {
        if (top_counter > 0) {
            plustop.disabled = false;
            top_counter--;
            formtop[top_counter].style.display = "none";
            if (top_counter == 0) {
                minustop.disabled = true;
            }
        }
    }

    function addbottom() {
        if (bottom_counter < 27) {
            minusbottom.disabled = false;
            formbottom[bottom_counter].style.display = "block";
            bottom_counter++;
            if (bottom_counter == 27) {
                plusbottom.disabled = true;
            }
        }
    }
    ...
    function removebottom() {
        if (bottom_counter > 0) {
            plusbottom.disabled = false;
            bottom_counter--;
            formbottom[bottom_counter].style.display = "none";
            if (bottom_counter == 0) {
                minusbottom.disabled = true;
            }
        }
    }
</script>
