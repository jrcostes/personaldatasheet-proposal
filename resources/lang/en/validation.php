...
return [
    ...
    */
    ...
    'custom' => [
        ...
        'residentialhouse' => ['max' => 'Maximum amount of characters reached', 'required' => 'Please input data',],
        'residentialst' => ['max' => 'Maximum amount of characters reached', 'required' => 'Please input data',],
        'residentialsudv' => ['max' => 'Maximum amount of characters reached', 'required' => 'Please input data',],
        'residentialcity' => ['max' => 'Maximum amount of characters reached', 'required' => 'Please input data',],
        'residentialprv' => ['max' => 'Maximum amount of characters reached', 'required' => 'Please input data',],
        'residentialzip' => ['max' => 'Maximum amount of characters reached', 'required' => 'Please input data',],
